...
{% set resultType %}{% if successType and options.modelNamespace %}{{ options.modelNamespace }}.{{ successType }}{% else %}{{ successType|default:"Void" }}{% endif %}{% endset %}
