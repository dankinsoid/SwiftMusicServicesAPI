...
public extension SoundCloud.API.Users {
	 ...
	 */
	func getByUserIdLikesTracks(userId user_id: Int, access: [Access]? = nil, limit: Int? = nil, linkedPartitioning: Bool? = nil, fileID: String = #fileID, line: UInt = #line) async throws -> OneOf<Tracks, TracksList> {
		try await client
