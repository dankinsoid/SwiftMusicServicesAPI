...
public extension SoundCloud.API.Users {
	 ...
	 */
	func getByUserIdFavorites(userId user_id: Int, limit: Int? = nil, linkedPartitioning: Bool? = nil, fileID: String = #fileID, line: UInt = #line) async throws -> OneOf<Tracks, TracksList> {
		try await client
