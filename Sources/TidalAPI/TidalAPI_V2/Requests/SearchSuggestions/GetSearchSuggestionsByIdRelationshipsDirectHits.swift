...
public extension Tidal.API.V2.SearchSuggestions {
	 ...
	 */
	func getByIdRelationshipsDirectHits(id: String, countryCode: CountryCode? = nil, explicitFilter: String? = nil, include: Bool = true, pageCursor: String? = nil, fileID: String = #fileID, line: UInt = #line) async throws -> TDO.MultiDataRelationshipDoc {
		try await client
