...
public extension Tidal.API.V2.Artists {
	 ...
	 */
	func getByIdRelationshipsProfileArt(id: String, countryCode: CountryCode? = nil, include: Bool = true, pageCursor: String? = nil, fileID: String = #fileID, line: UInt = #line) async throws -> TDO.MultiDataRelationshipDoc {
		try await client
