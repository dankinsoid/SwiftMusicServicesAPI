...
public extension Tidal.API.V2.Videos {
	 ...
	 */
	func getByIdRelationshipsThumbnailArt(id: String, countryCode: CountryCode? = nil, include: Bool = true, pageCursor: String? = nil, fileID: String = #fileID, line: UInt = #line) async throws -> TDO.MultiDataRelationshipDoc {
		try await client
