...
public extension Tidal.API.V2.Playlists {
	 ...
	 **GET** /playlists
	 */
	func get(countryCode: CountryCode? = nil, pageCursor: String? = nil, include: [Include]? = nil, ownersId: [String]? = nil, id: [String]? = nil, fileID: String = #fileID, line: UInt = #line) async throws -> TDO.PlaylistsMultiDataDocument {
		try await client
			.path("/playlists")
			.method(.get)
			.query([
