...
public extension Tidal.API.V2.UserRecommendations {
	...
	/**
	 ...
	 Retrieves current user's userRecommendation(s).
	     ...
	     */
	func getMe(countryCode: CountryCode? = nil, locale: String, include: [Include]? = nil, fileID: String = #fileID, line: UInt = #line) async throws -> TDO.UserRecommendationsSingleDataDocument {
		try await client
