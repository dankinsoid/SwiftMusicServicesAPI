...
extension YTO {
    ...
    public struct UploadStatus: Hashable, Codable {
    ...
    public struct FailureReason: Hashable, Codable {
    ...
    public struct RejectionReason: Hashable, Codable {
    ...
    public struct License: Hashable, Codable {
    ...
    public enum FileType: String, Hashable, Codable {
        ...
        public init(from decoder: any Decoder) throws {
            self = try Self.init(rawValue: String(from: decoder)) ?? .other
        }
    }

    public enum MyRating: String, Hashable, Codable {
        case dislike, like
    }
    
    public struct VideoCategoryID: Hashable, Codable {
