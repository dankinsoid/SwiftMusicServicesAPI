...
public extension YouTube.API.Search {
...
public extension YouTube.Objects {
	...
	enum SafeSearch: String, Codable {
		case moderate
		case none
		case strict
	}

	enum VideoCaption: String, Codable {
		case any
		case closedCaption
		case none
	}

	enum VideoDefinition: String, Codable {
		case any
		case high
		case standard
	}

	enum VideoDimension: String, Codable {
		case any
		case d2 = "2d"
		case d3 = "3d"
	}

	enum VideoDuration: String, Codable {
		case any
		case long
		case medium
		case short
	...
	enum VideoEmbeddable: String, Codable {
		case any
		case `true`
	}

	enum VideoLicense: String, Codable {
		case any
		case creativeCommon
		case youtube
	}

	enum VideoPaidProductPlacement: String, Codable {
		case any
		case `true`
	}

	enum VideoSyndicated: String, Codable {
		case any
		case `true`
	}
