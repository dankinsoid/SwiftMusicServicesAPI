...
public extension Amazon.Objects.Error {
...
public extension Amazon.Objects {
	...
	struct Scope: Hashable, ExpressibleByStringLiteral, LosslessStringConvertible, Codable {
	...
	enum DeviceTokenResponse: Codable, Equatable {
