...
public extension Amazon.Music.DeviceAPI {

	func browse() async throws -> Amazon.Objects.Document {
...
public extension Amazon.Objects {
	...
	struct NavigationNodeSummary: Codable, Equatable {
	...
	// Item Description
	struct ItemDescription: Codable, Equatable {
	...
	struct NavigationNodeDescription: Codable, Equatable {
